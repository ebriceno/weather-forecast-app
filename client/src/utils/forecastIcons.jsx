...
import { WiCloud, WiDaySunny, WiCloudy, WiRainMix, WiDayCloudy } from "weather-icons-react";
...
export const forecastIcons = Object.freeze({
  ...
  'default': <WiDayCloudy size={128} color='#D5E4F1'/>,
});
...
export const forecastIconsSmall = Object.freeze({
  ...
  'default': <WiDayCloudy size={68} color='#D5E4F1'/>,
});
